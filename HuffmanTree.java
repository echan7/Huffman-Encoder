...
/**
 * The Class HuffmanTree. It represents the output of the Huffman
...
public class HuffmanTree{
         ...
         */
        public HuffmanTree(String keyFile) throws IOException {
         ...
         */
        HuffmanTree(MinPriorityQueueADT mpq) 
        ...
        /**
         * Gets the root node of this HuffmanTree.
         *
         * @return 
         *      the root node
         */
